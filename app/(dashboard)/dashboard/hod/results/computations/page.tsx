...
export default function ComputationsPage() {
  ...
  const [showNotes, setShowNotes] = useState(false);
    ...
    { 
      text: "Master sheets are generated by level for each department", 
      type: "default" 
    },
    { 
      text: "Contact Admin if any computation wasn't successfull for your department", 
      type: "error" 
    },
    { 
      text: "Use filters to find specific computation results", 
      type: "info" 
    },
  ];
    ...
    <div className="min-h-screen bg-background p-6">
      ...
      <div className="mb-8 flex justify-between items-start">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-surface-elevated border border-border rounded-lg text-text2 hover:text-foreground hover:bg-background2 transition-colors"
          title="Show computation guidelines"
        >
          <HelpCircle className="w-5 h-5" />
          {showNotes ? "Hide Help" : "Show Help"}
        </button>
      </div>

      {/* Toggleable Notes Card */}
      {showNotes && (
        <div className="mb-6 animate-in fade-in duration-300">
          <NotesCard
            title="Computation Guidelines"
