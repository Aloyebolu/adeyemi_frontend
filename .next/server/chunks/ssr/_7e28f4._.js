...
function SignupPage() {
    ...
    const { signup, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
    ...
    const [form, set_form] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        id_value: "",
        password: "",
        role: "lecturer"
    });
    ...
    const handle_submit = async (e)=>{
        ...
        try {
            ...
            // Save session
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginAs"])(data?.user.role || "user", data?.user?.token, data?.user?.name, data?.user?.id || form.id_value);
...
//# sourceMappingURL=_7e28f4._.js.map